...
******************************/
$prefix = 'hh_'; // this prefix goes before the id of each meta field, like this: hh_case_study_name
$meta_boxes = array();
// first meta box
$meta_boxes[] = array(
	...
	'fields' => array( //field declarations create the fields in the metabox then get content from the callback function below
		...
		array(
			'name' => 'Vimeo Video',
			'desc' => 'Is there a video about this case study? You can put the ID# of a video on Vimeo.com here. You can find the ID in the url for the video, its the eight digits after vimeo.com/',
...
foreach ($meta_boxes as $meta_box) {
	$my_box = new case_study_meta_box($meta_box);
}
class case_study_meta_box {
	protected $_meta_box;
