...
$meta_boxes[] = array(
	...
	'fields' => array( //field declarations create the fields in the metabox then get content from the callback function below
		...
		array(
			'name' => 'Vimeo Video',
			'desc' => 'If there is a video about this project, you can put the ID# of a video on Vimeo.com here. You can find the ID in the url for the video, its the eight digits after vimeo.com/',
...
foreach ($meta_boxes as $meta_box) {
	$my_box = new project_meta_box($meta_box);
}
class project_meta_box {
	protected $_meta_box;
